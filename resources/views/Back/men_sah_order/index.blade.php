...
<div class="container-fluid">
    ...
    <!-- Page Heading -->
    <h1 class="h3 mb-2 text-gray-800">Teklif</h1>
    ...
    <div class="card shadow mb-4">
        ...
        <div class="card-body">
            ...
            <form action="{{route('admin.order.store')}}" method="post" enctype="multipart/form-data">
                ...
                <div class="col-md-6">
                        <div class="mb-3">
                            <label for="title" class="form-label">Teklif</label>
                            <input type="text" name='teklif' value="{{old('teklif')}}" class="form-control" id="title"
                    ...
                    <div class="col-md-6">
                        <div class="mb-3">
                            <label for="title" class="form-label">Sifaris</label>
                            <input type="text" name='sifaris' value="{{old('sifaris')}}" class="form-control" id="title"
                                aria-describedby="emailHelp" placeholder='Name'>
                            <span class="text-danger">@error('title'){{'Title sahəsi boş ola bilməz!'}}@enderror</span>
                        </div>
                    </div>
