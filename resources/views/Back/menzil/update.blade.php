...
<div class="container-fluid">
    ...
    <div class="card shadow mb-4">
        ...
        <div class="card-body">
            ...
            <form action="{{route('admin.menzil.update',$menzil->id)}}" method="POST" enctype="multipart/form-data">
                @method("PUT")
                @csrf
                <div class="row">
                    <div class="col-md-6">
                    ...
                    <div class="col-md-6">
                        <div class="mb-3">
                            ...
                            <input type="text" name='menzil' value="{{$menzil->menzil}}" class="form-control" id="title"
